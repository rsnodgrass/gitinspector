...
class GitHubResultsCache:
    ...
    def _generate_cache_key(self, repositories: List[str], since: str = None, 
                           cache_timestamps: Dict[str, str] = None) -> str:
        """
        Generate a cache key based on repositories, since parameter, and cache timestamps.
    ...
    def get_cached_results(self, repositories: List[str], since: str = None, 
                          cache_timestamps: Dict[str, str] = None) -> Optional[Dict[str, Any]]:
        """
        ...
        """
        cache_key = self._generate_cache_key(repositories, since, cache_timestamps)
    ...
    def _is_cache_valid(self, cache_info: Dict[str, Any], 
                       cache_timestamps: Dict[str, str] = None) -> bool:
        """
    ...
    def cache_results(self, repositories: List[str], results: Dict[str, Any], 
                     since: str = None, cache_timestamps: Dict[str, str] = None):
        """
