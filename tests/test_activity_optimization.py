...
class TestActivityOptimizationIntegration(GitInspectorTestCase):
    ...
    def test_activity_only_skips_blame_analysis(self, mock_metrics, mock_changes, mock_blame):
        ...
        with patch('os.chdir'), patch('os.getcwd', return_value="/tmp"), \
             patch('gitinspector.gitinspector.format'), \
             patch('gitinspector.gitinspector.outputable'), \
             patch('gitinspector.gitinspector.terminal'), \
             patch('gitinspector.gitinspector.localization'):
